...
-- Da eseguire UNA SOLA VOLTA, su un progetto Supabase NUOVO (vuoto).
--
-- ⚠️ NON rieseguirlo su un database già in uso: fallirebbe con errori
--    tipo "relation already exists" (ed è giusto così: è una protezione).
--    Per aggiornare un database attivo si usano solo i file migration-*.sql.
--    Per azzerare davvero tutto (cancellando i dati!) c'è reset-database.sql.
-- ============================================================
